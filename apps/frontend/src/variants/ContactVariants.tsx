...
export const ContactVariantA: React.FC = () => {
  ...
  return (
    <PowerSolarSection id="contact" background="gradient" height="auto">
      <div className="max-w-3xl mx-auto text-center">
        <h2 className="text-4xl font-bold text-gray-900 mb-4 font-display">
          {t('home:contact.title')}
        </h2>
        <p className="text-xl text-gray-600 mb-8">
          {t('home:contact.subtitle')} <strong>087-0644982</strong>
        </p>
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">087-0644982</p>
              </div>
            </div>
      ...
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600">
            Call <strong>087-0644982</strong> or fill out the form below
          </p>
        </div>
